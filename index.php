            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        ...
                        <p>Hotel dengan pemandangan yang indah, sejuk, dan menyegarkan merupakan salah satu opsi terbaik untuk menikmati hari libur seseorang. MIVY Hotel menyediakan pemandangan yang paling indah dan juga pastinya akan menyejukkan mata Anda.</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Universitas Negeri Surabaya | Pemrograman Berorientasi Objek <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Yunike Shandy Jholan Ninggar, Ananda Mayang Septia, Verani Fajrin Triana, Intan Rachmalia Dewi</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <select class="form-select wide" name="room_tipe" id="default-select" class="">
                                            ...
                                            <option value="1">Duluxe Rooms</option>
