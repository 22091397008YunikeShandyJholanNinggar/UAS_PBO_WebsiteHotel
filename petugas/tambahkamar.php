              ...
              <form action="upload.php" method = "POST" autocomplete="off" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="jenis_kamar" class="form-control" id="exampleInputEmail1" placeholder="Masukan Jenis Kamar">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Fasilitas Kamar</label>
                    <input type="text" name="fasilitas_kamar" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Fasilitas Kamar">
                  </div>
                  <div class="form-group">
                    <label>Jumlah Kasur</label>
                    <input type="number" name="jumlah" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Jumlah Kasur">
                  </div>
                  <div class="form-group">
