            ...
            <div class="card card-primary">
              ...
              <form action="simpan_edit_fasilitas.php" method = "POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <?php
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM fasilitas1 WHERE id_fasilitas = $id_fasilitas");
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" name="ket_fasilitas" class="form-control" id="exampleInputPassword1" value= "<?php echo $data['ket_fasilitas'];?>"> </textarea>
                  </div>
                  <div class="form-group">
